...
public class UploadSupplierDocumentHandler : IRequestHandler<UploadSupplierDocumentCommand, UploadSupplierDocumentResponse?>
{
    ...
    public UploadSupplierDocumentHandler(ISupplierRepository supplierRepository, ISupplierDocumentRepository documentRepository, IFileStorageService storage)
    {
